...
def setup_characters():
    ...
    while True:
        ...
        print("2 - Modes bonus")
        print("3 - Challenge de la semaine (Internet requis)")
        ...
        if main_choice == "1":
            ...
            while True:
                clear_console()
                print("=== Choisissez mode extreme ===")
                print("1 - La Faucheuse\033[0m")
                print("1.5 - Le Minautaure\033[0m")
                print("2 - Le Stalker\033[0m")
                print("2.5 - L'Architecte\033[0m")
                print("3 - Le Fou Condamné\033[0m")
                print("b - Retour")
                print("====================================")
...
"8: Fracture [45 Mageie] (Inflige 35 dégâts au bouclier enemi)\n"
"9: Retour\n"
"---------------------------------------------------\n"
)
...
def resolve_enemy_attack(enemy_name, enemy_damage):
    ...
    if last_player_action == "counter":
        ...
        counter_damage = int(psh * 0.75)
        epv -= counter_damage
        
        print(f"Joueur subit {reduced_damage} dégâts et renvoie {counter_damage} dégâts !")
        if effects.get("réflexion"):
            print(f"L'adveraire réfléchit 10% des dégâts recus, vous perdez " + str(counter_damage*0.10) + "PVs!")
            ppv -= int(counter_damage*0.10)
